...
export class CurrencyComponent extends SpBLBase<Currency> implements OnInit  {
  ...
  constructor(
    ...
    public messageDialog?: MessageDialogeService
      ...
      this.formTitle = "Currency";
  
      //Defined SP List Title
      this.addListTitle("Currency", "Currency");
      this.query = {
      ...
      onCreate(form: NgForm) {
        this.router.navigate(['/admin/Currency/form'], { replaceUrl: true });
        //BLBase function
        this.Create();
      }
  ...
  onSubmit(form: NgForm) {
    ...
    objCurrency.ID = this.formData.ID;
    objCurrency.Title = this.formData.Title;
    objCurrency.Inactive = this.formData.Inactive;
    this.insertRecord(objCurrency);
  }
