...
export class StatusComponent extends SpBLBase<Status> implements OnInit  {
  ...
  constructor(
    ...
    public messageDialog?: MessageDialogeService
      ...
      this.formTitle = "Status";
  
      //Defined SP List Title
      this.addListTitle("Status", "Status");
      this.query = {
      ...
      onCreate(form: NgForm) {
        this.router.navigate(['/admin/Status/form'], { replaceUrl: true });
        //BLBase function
        this.Create();
      }
  ...
  AfterInsert(jsonObject: any) {
    this.router.navigate(['/admin/Status/list']);
  }
